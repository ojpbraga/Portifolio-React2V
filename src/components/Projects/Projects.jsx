...
const slidesObj = [
    ...
    },
    {
      ...
      title: "Roadmap", 
      description: "Plataforma desenvolvida para potencializar o aprendizado. Professores criam trilhas de estudo (roadmaps) de suas disciplinas, e os alunos podem centralizar e acessar todos os seus cursos na aplicação.", 
    ...
    },
    {
      ...
      description: "Aplicação interativa no formato de roadmap, criada em equipe como projeto final acadêmico. Desenvolvida para facilitar e aprimorar o aprendizado visual das turmas de enfermagem.", 
    ...
    },
    {
      ...
      title: "UniSUS", 
      description: "Sistema dinâmico de prontuário médico eletrônico. Permite que profissionais de saúde realizem o cadastro de pacientes e gerenciem históricos de consultas de forma segura.", 
...
const Projects = () => {
    ...
    return (
        <section id="projetos" className='h-[88dvh] w-full flex flex-col items-center justify-center gap-4 overflow-hidden'>
